...
// let 10 m per block
function Wall(x,y,length,angle, clrIndex){
    this.create(x,y,length,angle, clrIndex);
}
Wall.prototype = {
    create: function(x,y,length,angle, clrIndex){
        //debugger;
        //this.shape = World.create();
            ...
            this.shape = WorldHelper.createStaticFloor(x,y,length,blockSide, true);
    ...
    clean: function(){
        this.shape.clean();
        stageB.removeChild(this.container);
    }, // end clean
    getClr: function(num){
        ...
        switch(clr){
            case 0: case 1: case 2: case 3:
                if(num == 4) return Assets.textures.block4RedTexture;
                if(num == 1) return Assets.textures.blockRedTexture;
            break;
            case 4: case 5: case 6: case 7:
                if(num == 4) return Assets.textures.block4GreenTexture;
                if(num == 1) return Assets.textures.blockGreenTexture;
            break;
            case 8: case 9: case 10: case 11:
                if(num == 4) return Assets.textures.block4YellowTexture;
                if(num == 1) return Assets.textures.blockYellowTexture;
            break;
            case 12: case 13: case 14: case 15:
                if(num == 4) return Assets.textures.block4BlueTexture;
                if(num == 1) return Assets.textures.blockBlueTexture;
            break;
        }
    }, // end getClr
} // end Wall